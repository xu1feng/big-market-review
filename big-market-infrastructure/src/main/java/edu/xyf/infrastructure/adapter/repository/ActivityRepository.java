...
import edu.xyf.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
import edu.xyf.domain.activity.model.valobj.ActivityStateVO;
...
import edu.xyf.infrastructure.dao.*;
import edu.xyf.infrastructure.dao.po.*;
import edu.xyf.infrastructure.event.EventPublisher;
import edu.xyf.infrastructure.redis.IRedisService;
